...
#define __PYX_HAVE__numina__array__peaks___kernels
#define __PYX_HAVE_API__numina__array__peaks___kernels
/* Early includes */
#include <string.h>
#include <stdlib.h>
#ifdef _OPENMP
...
int __pyx_module_is_main_numina__array__peaks___kernels = 0;

/* Implementation of 'numina.array.peaks._kernels' */
...
static const char __pyx_k_fpeak[] = "fpeak";
static const char __pyx_k_range[] = "range";
static const char __pyx_k_result[] = "result";
static const char __pyx_k_threshold[] = "threshold";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_kernel_peak_function[] = "kernel_peak_function";
static const char __pyx_k_numina_array_peaks__kernels[] = "numina.array.peaks._kernels";
static const char __pyx_k_numina_array_peaks_kernels_pyx[] = "numina/array/peaks/kernels.pyx";
static PyObject *__pyx_n_s_MemoryError;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_data;
static PyObject *__pyx_n_s_fpeak;
static PyObject *__pyx_n_s_kernel_peak_function;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_name;
static PyObject *__pyx_n_s_numina_array_peaks__kernels;
static PyObject *__pyx_kp_s_numina_array_peaks_kernels_pyx;
...
/* "numina/array/peaks/kernels.pyx":12
 * 
...
static int __pyx_f_6numina_5array_5peaks_8_kernels__kernel_function(double *__pyx_v_buffer, int __pyx_v_filter_size, double *__pyx_v_return_value, void *__pyx_v_cb) {
  double *__pyx_v_data;
  int __pyx_v_nmed;
  int __pyx_v_i;
  int __pyx_v_start;
  ...
  /* "numina/array/peaks/kernels.pyx":14
 * cdef int _kernel_function(double* buffer, int filter_size,
 *                           double* return_value, void* cb):
 *     cdef double* data = <double*> cb             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "numina/array/peaks/kernels.pyx":15
 *                           double* return_value, void* cb):
 *     cdef double* data = <double*> cb
 *     cdef int nmed = filter_size // 2             # <<<<<<<<<<<<<<
 *     cdef int i = 0
 ...
 */
  ...
  /* "numina/array/peaks/kernels.pyx":17
 *     cdef int nmed = filter_size // 2
 *     cdef int i = 0
 *     cdef int start = 0             # <<<<<<<<<<<<<<
 *     cdef int mcount = 0
 ...
 */
  __pyx_t_2 = (__pyx_v_filter_size - 1);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = __pyx_v_nmed; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "numina/array/peaks/kernels.pyx":30
 *         # print '0-',i, i+1
 *         # print '0-',buffer[i], buffer[i+1]
 ...
 */
  ...
  /* "numina/array/peaks/kernels.pyx":37
 *             break
 * 
 *     for i in range(start, filter_size-1):             # <<<<<<<<<<<<<<
 *         if buffer[i] <= buffer[i+1]:
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "numina/array/peaks/kernels.pyx":45
 *     for i in range(nmed, 0, -1):
 *         if buffer[i] == buffer[i-1]:
 *             mcount += 1             # <<<<<<<<<<<<<<
 *             start = i - 1
 ...
 */
  ...
  /* "numina/array/peaks/kernels.pyx":51
 *             break
 * 
 *     for i in range(0, start):             # <<<<<<<<<<<<<<
 *         if buffer[i] >= buffer[i+1]:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "numina/array/peaks/kernels.pyx":59
 *     # flat values
 *     if mcount > limit:
 *         return_value[0] = 0.0             # <<<<<<<<<<<<<<
 *         return 1
...
static void __pyx_f_6numina_5array_5peaks_8_kernels__destructor_cobj(CYTHON_UNUSED void *__pyx_v_cobject, void *__pyx_v_kernel_data) {
  __Pyx_RefNannyDeclarations
...
static void __pyx_f_6numina_5array_5peaks_8_kernels__destructor_cap(PyObject *__pyx_v_cap) {
  void *__pyx_v_cdata;
  __Pyx_RefNannyDeclarations
  void *__pyx_t_1;
  int __pyx_lineno = 0;
 ...
 * 
 */
  __pyx_t_1 = PyCapsule_GetContext(__pyx_v_cap); if (unlikely(__pyx_t_1 == ((void *)NULL) && PyErr_Occurred())) __PYX_ERR(0, 72, __pyx_L1_error)
  __pyx_v_cdata = __pyx_t_1;

  /* "numina/array/peaks/kernels.pyx":73
 *     cdef void *cdata
 *     cdata = PyCapsule_GetContext(cap)
 *     free(cdata)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("numina.array.peaks._kernels._destructor_cap", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6numina_5array_5peaks_8_kernels_1kernel_peak_function(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6numina_5array_5peaks_8_kernels_1kernel_peak_function = {"kernel_peak_function", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6numina_5array_5peaks_8_kernels_1kernel_peak_function, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6numina_5array_5peaks_8_kernels_1kernel_peak_function(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("kernel_peak_function (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "kernel_peak_function") < 0)) __PYX_ERR(0, 76, __pyx_L3_error)
      }
    } else {
    ...
    if (values[0]) {
      __pyx_v_threshold = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_threshold == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 76, __pyx_L3_error)
    } else {
      __pyx_v_threshold = ((double)0.0);
    }
    if (values[1]) {
      __pyx_v_fpeak = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_fpeak == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 76, __pyx_L3_error)
    } else {
      __pyx_v_fpeak = ((int)1);
    }
  }
  ...
  __Pyx_RaiseArgtupleInvalid("kernel_peak_function", 0, 0, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 76, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("numina.array.peaks._kernels.kernel_peak_function", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6numina_5array_5peaks_8_kernels_kernel_peak_function(__pyx_self, __pyx_v_threshold, __pyx_v_fpeak);
...
static PyObject *__pyx_pf_6numina_5array_5peaks_8_kernels_kernel_peak_function(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_threshold, int __pyx_v_fpeak) {
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "numina/array/peaks/kernels.pyx":83
 *     data = <double*>malloc(2 * sizeof(double))
 *     if data is NULL:
 *         raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 *                            _destructor_cap)
 */
  __pyx_t_2 = PyCapsule_New((&__pyx_f_6numina_5array_5peaks_8_kernels__kernel_function), NULL, __pyx_f_6numina_5array_5peaks_8_kernels__destructor_cap); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 89, __pyx_L1_error)
 ...
 *     return result
 */
  __pyx_t_3 = PyCapsule_SetContext(__pyx_v_result, __pyx_v_data); if (unlikely(__pyx_t_3 == ((int)-1))) __PYX_ERR(0, 93, __pyx_L1_error)
...
static int __pyx_pymod_exec__kernels(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__kernels},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_fpeak, __pyx_k_fpeak, sizeof(__pyx_k_fpeak), 0, 0, 1, 1},
  {&__pyx_n_s_kernel_peak_function, __pyx_k_kernel_peak_function, sizeof(__pyx_k_kernel_peak_function), 0, 0, 1, 1},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_n_s_name, __pyx_k_name, sizeof(__pyx_k_name), 0, 0, 1, 1},
  {&__pyx_n_s_numina_array_peaks__kernels, __pyx_k_numina_array_peaks__kernels, sizeof(__pyx_k_numina_array_peaks__kernels), 0, 0, 1, 1},
  {&__pyx_kp_s_numina_array_peaks_kernels_pyx, __pyx_k_numina_array_peaks_kernels_pyx, sizeof(__pyx_k_numina_array_peaks_kernels_pyx), 0, 0, 1, 0},
 ...
 *     cdef object result
 */
  __pyx_tuple_ = PyTuple_Pack(4, __pyx_n_s_threshold, __pyx_n_s_fpeak, __pyx_n_s_result, __pyx_n_s_data); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_numina_array_peaks_kernels_pyx, __pyx_n_s_kernel_peak_function, 76, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_kernels(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_kernels(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__kernels(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__kernels(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__kernels(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_kernels' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__kernels(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_kernels", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_numina__array__peaks___kernels) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "numina.array.peaks._kernels")) {
      if (unlikely(PyDict_SetItemString(modules, "numina.array.peaks._kernels", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef object result
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6numina_5array_5peaks_8_kernels_1kernel_peak_function, NULL, __pyx_n_s_numina_array_peaks__kernels); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_kernel_peak_function, __pyx_t_1) < 0) __PYX_ERR(0, 76, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init numina.array.peaks._kernels", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init numina.array.peaks._kernels");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
